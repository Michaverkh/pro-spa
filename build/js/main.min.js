...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_main_nav__WEBPACK_IMPORTED_MODULE_2__["openMenu"])();
  Object(_modules_goods__WEBPACK_IMPORTED_MODULE_3__["renderGoods"])(_modules_goods__WEBPACK_IMPORTED_MODULE_3__["goodList"]); // Modules
  // ---------------------------------
...
/*!*****************************!*\
  !*** ./js/modules/goods.js ***!
  \*****************************/
/*! exports provided: goodList, renderGoods */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var goodTemplate = document.querySelector('#goods-template').content.querySelector('.good-item');
var renderGoods = function renderGoods(data) {
  data.forEach(function (good) {
    var goodElement = goodTemplate.cloneNode(true); // const tripNames = goodElement.querySelectorAll('.cruis-item__header');
